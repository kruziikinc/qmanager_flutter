...
import 'package:qmanagement/dialog/ZipCodeDialog.dart';
import 'package:qmanagement/model/OutletModel.dart';
import 'package:qmanagement/model/ShopModel.dart';
...
Future<List<OutletModel>> getShopList(String zipcode) async {
  ...
  // make POST request
  final response = await http.post(AppConstant.API_SHOP_LIST, body: bodyParams);

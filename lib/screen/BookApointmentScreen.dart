...
import 'package:qmanagement/model/AvailableSlotModel.dart';
import 'package:qmanagement/model/BookingModel.dart';
import 'package:qmanagement/model/OutletDetailModel.dart';
import 'package:qmanagement/model/OutletModel.dart';
import 'package:qmanagement/presentation/custom_icons_icons.dart';
...
class _BookApointmentScreenState extends State<BookApointmentScreen> {
  ...
  List<Widget> getShopTimingsDetails() {
    List<Widget> arrList = new List<Widget>();

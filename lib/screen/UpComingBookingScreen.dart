...
import 'package:qmanagement/dialog/TransferBookingDialog.dart';
import 'package:qmanagement/model/BookingListModel.dart';
...
Future<List<BookingListModel>> getBookingList() async {
  ...
  // make POST request
  final response =
      await http.post(AppConstant.API_UPCOMING_BOOKING_LIST, body: bodyParams);

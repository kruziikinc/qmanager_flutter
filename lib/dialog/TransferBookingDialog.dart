...
class TransferBookingDialog extends StatelessWidget {
    ...
    return Container(
      child: TextField(
        ...
        decoration: InputDecoration(
          labelStyle: TextStyle(fontWeight: FontWeight.normal, fontSize: 16, color: AppColors.grayColor),
          labelText: hint,
  ...
  bool isValid() {
    if (_emailController.text.isEmpty || !Utility().isValidEmail(_emailController.text)) {
            ...
            children: <Widget>[
              Text("Transfer the booking\nAppointment to other User",
                  ...
                  style: new TextStyle(
                      ...
                      color: AppColors.grayColor)),
              SizedBox(height: 20,),
              _input("Enter Email", _emailController, false, TextInputType.emailAddress),

              SizedBox(height: 30,),

              Container(
                child: _button( AppLocalizations.of(context).translate('str_transfer'), Colors.red, Colors.red, Colors.red,
                    Colors.white, transferClick),
                height: 40,
                width: 150,
              ),

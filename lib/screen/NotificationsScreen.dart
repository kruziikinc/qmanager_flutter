...
import 'package:qmanagement/model/NotificationModel.dart';
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  void getNotificationListAPI(bool showLoader) async {
    ...
    final response =
        await http.post(AppConstant.API_NOTIFICATION_LIST, body: bodyParams);
  ...
  List<NotificationModel> createNotificationList(List data) {
    List<NotificationModel> list = new List();
